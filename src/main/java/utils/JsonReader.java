...
public final class JsonReader {
	...
	private static InputStream getFile(String fileName) {
		...
		InputStream inputStream = JsonReader.class.getClassLoader().getResourceAsStream(jsonFolder + fileName);
	...
	public static String readJsonAsString(String fileName) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to read JSON : " + fileName, e);
	...
	public static Map<String, Object> readJsonObject(String fileName) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JSON Object : " + fileName, e);
	...
	public static List<Map<String, Object>> readJsonArray(String fileName) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JSON Array : " + fileName, e);
	 ...
	 * Read JSON as POJO.
	 */
	public static <T> T readJsonAsPojo(String fileName, Class<T> clazz) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JSON POJO : " + fileName, e);

		}
	}

	/**
	 * Read JSON Array as List of POJOs.
	 */
	public static <T> List<T> readJsonAsPojoList(String fileName, Class<T> clazz) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JSON POJO List : " + fileName, e);
	...
	public static <T> T readJson(String fileName, TypeReference<T> typeReference) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JSON : " + fileName, e);
	...
	public static JsonNode readJsonNode(String fileName) {
		...
		try (InputStream inputStream = getFile(fileName)) {
			...
			throw new RuntimeException("Unable to parse JsonNode : " + fileName, e);
